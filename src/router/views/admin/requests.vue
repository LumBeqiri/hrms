                ...
                <b-row align-v="center">
                    ...
                    <div class="col-6 col-md-6 col-sm-6 col-lg-6 col-xl-6">
                        ...
                        <div class="hrms_actions text-right">
                              <ul>
                                <li>
                                    <b-button variant="primary" @click="openNewUserModal">Make a request</b-button>
                                </li>
                              </ul>
                          </div>
                    </div>
             ...
             <template v-else>
               <nav aria-label="Page navigation example">
                  <ul class="pagination">
                    ...
                    <p>Page {{requests.current_page}}</p>
                      ...
                      <tr v-for="(request_item, index) in requests.data" :key="index">
                          ...
                          <template v-if="user_role.name === CEO() || user_role.name === HR_MANAGER() ">
                              <td class="table-actions">
                                <b-button size="md" @click="approveRequest(request_item.id)" variant="success" class="ml-2" type="submit">Approve</b-button>
                                <b-button size="md" @click="denyRequest(request_item.id)" variant="danger" class="ml-2" type="submit">Deny</b-button>
                              </td>
                          </template>
                           <template v-else>
